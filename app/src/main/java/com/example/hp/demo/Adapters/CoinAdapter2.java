...
/**
 * Created by Mohammad Arsalan on 10/23/2018.
 */

public class CoinAdapter2 extends RecyclerView.Adapter<CoinAdapter2.ViewHolder> {
    ...
    public CoinAdapter2(List<ListItem> listItems, Context context) {
    ...
    @NonNull
    @Override
    public CoinAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.coin_layout, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final CoinAdapter2.ViewHolder holder, final int position) {
